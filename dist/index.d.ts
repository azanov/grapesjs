...
declare class StyleableModel<T extends ObjectHash = any> extends Model<T> {
	 ...
	 * @return {Object}
	 */
	getStyle(prop?: string | ObjectAny): any;
	/**
...
declare class ComponentManager extends ItemManagerModule {
	componentTypes: ({
		id: string;
...
declare class Component extends StyleableModel<ComponentProperties> {
	 ...
	 * @return {Object}
	 */
	getStyle(options?: any, optsAdd?: any): any;
	/**
...
declare class CssComposer extends ItemManagerModule<CssComposerConfig & {
	 ...
	 * });
	 * */
	get(selectors: any, state?: string, width?: string, ruleProps?: Omit<CssRuleProperties, "selectors">): CssRule;
	getAll(): CssRules;
	/**
...
declare class EditorModel extends Model {
	 ...
	 * @private
	 */
	tsLoadModule(moduleName: any): this;
	/**
...
declare abstract class ItemManagerModule<TConf extends ModuleConfig = any, TCollection extends Collection = Collection> extends Module<TConf> {
	cls: any[];
...
declare class Editor implements IBaseModule<EditorConfig> {
